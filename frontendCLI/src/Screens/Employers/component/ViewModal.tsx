  ...
  const sections = [
    ...
    },
    {
      ...
      data: [
        ...
        { label: 'Job Station:', value: user.profile?.profileDetails?.jobStationName || 'N/A' },
        ...
        { label: 'NIC Sector:', value: user.profile?.profileDetails?.nicSectorCode || 'N/A' },
        { label: 'District:', value: user.profile?.profileDetails?.district || 'N/A' },
        { label: 'Local Body:', value: user.profile?.profileDetails?.localBodyName || 'N/A' },
    ...
    },
    {
      ...
      data: [
        {
          label: 'Resume:',
          value: user.resumeDetails?.[0]?.filename || 'N/A',
          onPress: user.resumeDetails?.[0]?._id ? () => openFileViewer(user.resumeDetails?.[0]) : undefined,
        },
        {
          label: 'Referral Letter:',
          value: user.referralLetterDetails?.[0]?.filename || 'N/A',
      ...
      <View style={styles.modalContainer}>
        ...
        >
          <View style={styles.modalHeader}>
            <Text style={styles.modalTitle}>Employer Details</Text>
